...
const inputSources = [
  { name: "Google Ads", color: "oklch(0.65 0.2 145)" },
  { name: "TikTok Ads", color: "oklch(0.55 0.2 330)" },
  { name: "Meta Ads", color: "oklch(0.55 0.2 250)" },
];

const outputCategories = [
  { name: "Hot Leads", subtitle: "Ready to Buy", dotColor: "bg-success-600" },
  { name: "Warm Leads", subtitle: "Nurturing", dotColor: "bg-warning-900" },
